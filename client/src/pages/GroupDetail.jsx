...
import api from "../api";import { useEffect, useState, useContext } from "react";
import { useParams, useNavigate } from "react-router-dom";
import api from "../api";
...
export default function GroupDetail() {
  ...
  const handleAiParse = async (e) => {
    ...
    try {
      ...
      setAiPrompt(""); 
      alert(`AI Understood:\nAmount: ${res.data.amount}\nCategory: ${res.data.category}\nPayer: ${res.data.payer === payer ? "Unchanged" : "Updated"}`);
    } catch (err) { alert("AI could not understand that. Try: 'Pizza 500 paid by Alice'"); }
